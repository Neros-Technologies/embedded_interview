/**
  ...
  * @brief          : Inverted half-duplex interview question.
  ******************************************************************************
  * @attention
  *
  * INTERVIEW: You are designing a program to pass through serial signals between two UART ports. 
...
int main(void)
{
  ...
  while (1)
  {
    ////TODO: Add any code inside of while loop
  }
}
